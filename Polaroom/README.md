...
Este README descreve apenas o que está versionado no Git. Descrição mais complexa para devs.
...
A principio, o projeto estava sendo construido apenas em HTML, CSS e JavaScript, mas conforme fui sendo apresentada à novas tecnologias na faculdade, decidi implementa-las no projeto também. Muitas funções foram aprendidas por cursos no yoautube ou usando IA para aperfeiçoar detalhes.

## O que é o projeto

O Polaroom é uma aplicação pessoal inspirada em "eras", usada para organizar e armazenar links, playlists, notas, resumos, repositórios, preferências e outros dados do dia a dia.
